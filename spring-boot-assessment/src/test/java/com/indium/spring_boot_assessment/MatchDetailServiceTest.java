...
public class MatchDetailServiceTest {
    ...
    void testClearCache() {
        ...
        assertThat(cacheManager.getCache("playername")).isNotNull();
        assertThat(cacheManager.getCache("score")).isNotNull();
        assertThat(cacheManager.getCache("scorebydate")).isNotNull();
        assertThat(cacheManager.getCache("battername")).isNotNull();
    }
}
